...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="diffuEraser-model-stage1",
...
def main(args):
    ...
    logger.info("Loading existing unet weights from base model")
    ...
    brushnet_optimize_params = []
    for param in brushnet.parameters():
        if param.requires_grad:
            brushnet_optimize_params.append(param)

    params_to_optimize = uent_main_optimize_params + brushnet_optimize_params
